...
libraryList <- c("devtools","tidyverse", "tibble", "synthpop","gridExtra", "data.table", "dplyr", "caret",
                 "rpart","rpart.plot", "RColorBrewer", "ROCR")
ipak(libraryList)
...
K = 4
M = 50  #   TALK ABOUT THE LEVEL OF M THAT WILL UP THE ACCURACY 
my.Seed = 1111
set.seed(my.Seed)
...
for (train.Set in train.List)
{
  ...
  # print(FMeasure)
  # predictions <- prediction((as.numeric(preds) -1), (as.numeric(test$Episode) -1))
  # print(performance(predictions, "f"))
