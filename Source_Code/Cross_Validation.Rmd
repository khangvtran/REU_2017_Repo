...
{ 
  ...
  train[,(ncol(train)-1)] <- as.integer(train[,(ncol(train)-1)])
  test[,(ncol(test)-1)] <- as.integer(test[,(ncol(test)-1)])
  ###################################################################################
  # # Convert Episode to factor, leave this part out after plugging in to Test_Each_Fold
...
K = 5
M = 5 #  40 TALK ABOUT THE LEVEL OF M THAT WILL UP THE ACCURACY 
my.Seed = 111
